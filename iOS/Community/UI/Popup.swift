...
struct Popup<T: View>: ViewModifier {
    ...
    let onDismiss: Command
    
    init(isPresented: Bool, alignment: Alignment, direction: Direction, @ViewBuilder content: () -> T, onDismiss: @escaping Command) {
...
extension View {
    func popup<T: View>(
        ...
        onDismiss: @escaping Command
    ) -> some View {
        return modifier(Popup(isPresented: isPresented, alignment: alignment, direction: direction, content: content, onDismiss: onDismiss))
    }
}
